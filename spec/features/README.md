...
| [Worktree Checkpoint](worktree-checkpoint/README.md) | Draft | A cheap, repeatable, hook-proof snapshot that preserves in-flight worktree state against crashes, independent of whether the work compiles or is ready to commit. |
