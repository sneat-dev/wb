...
| [agent-session-move](agent-session-move/README.md) | Under Review | Move an active AI agent session to another WB machine through an interchangeable courier while preserving Git state, handover context, lineage, and Work Log evidence. |
