...
13. **Flaky tests.** "Fix all flaky tests": every statement whose coverage varies between identical runs, and every flaky test, is fixed at source — see task-21.
