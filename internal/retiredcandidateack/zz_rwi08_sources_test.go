...
func TestRWI08SameSourcesLengthMismatch(t *testing.T) {
	t.Parallel()
...
func TestRWI08SameSourcesEqualAndDiffering(t *testing.T) {
	t.Parallel()
...
func TestRWI08DistinctCandidateIncompleteOrEmpty(t *testing.T) {
	t.Parallel()
...
func TestRWI08DistinctCandidateOverlapping(t *testing.T) {
	t.Parallel()
