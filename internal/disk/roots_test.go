...
func TestWorktreeRootsSkipsNonDirEntries(t *testing.T) {
	t.Parallel()
	root := t.TempDir()
...
// TestScratchRootsSkipsNonDirWbEntries touches the real OS temp
...
func TestScratchRootsSkipsNonDirWbEntries(t *testing.T) {
