...
func TestPkp02MergeReleaseObservations(t *testing.T) {
	t.Parallel()
...
func TestPkp02GithubActionsInspectWorkingTreeRootUnreadable(t *testing.T) {
	t.Parallel()
	worktree := t.TempDir()
...
func TestPkp02GithubActionsInspectWorkingTreeWalkErr(t *testing.T) {
	t.Parallel()
	worktree := t.TempDir()
...
func TestPkp02GithubActionsInspectWorkingTreeSuccess(t *testing.T) {
	t.Parallel()
	worktree := t.TempDir()
	workflows := filepath.Join(worktree, ".github", "workflows")
...
func TestPkp02GoAdapterInspectWorkingTree(t *testing.T) {
	t.Parallel()
	worktree := t.TempDir()
...
func TestPkp02NpmAdapterInspectWorkingTreePackageBlocked(t *testing.T) {
	t.Parallel()
	worktree := t.TempDir()
	pkg := "{\n  \"dependencies\": {\n    \"other-pkg\": \"1.0.0\",\n    \"example-pkg\": \"2.0.0\"\n  }\n}\n"
...
func TestPkp02NpmAdapterInspectWorkingTreeWorkspaceBlocked(t *testing.T) {
	t.Parallel()
	worktree := t.TempDir()
	workspace := "overrides:\n  other-pkg: 1.0.0\n  example-pkg: 2.0.0\n"
...
func TestPkp02NpmAdapterInspectWorkingTreeEmpty(t *testing.T) {
	t.Parallel()
	worktree := t.TempDir()
