...
func TestApplyNpmPackageJSONOverrideSkipsNonMatchingKeys(t *testing.T) {
	t.Parallel()
	contents := []byte("{\n  \"dependencies\": {\n    \"foo\": \"1.0.0\",\n    \"bar\": \"2.0.0\"\n  }\n}\n")
...
func TestApplyPnpmWorkspaceOverrideSkipsNonMatchingKeys(t *testing.T) {
	t.Parallel()
...
func TestScanPnpmWorkspaceRefsClosesNamedCatalogOnDedent(t *testing.T) {
	t.Parallel()
...
// TestDependencySectionsPanicsOnUnknownField deliberately mutates the
...
func TestDependencySectionsPanicsOnUnknownField(t *testing.T) {
