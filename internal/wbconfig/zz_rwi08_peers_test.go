...
func TestRWI08IsLoopbackPeersHostEqualFold(t *testing.T) {
	t.Parallel()
...
func TestRWI08SetPeersUpstreamInjectedReadDirError(t *testing.T) {
	t.Parallel()
...
func TestRWI08ParsePeersBodyRejectsTab(t *testing.T) {
	t.Parallel()
...
func TestRWI08ParseFlatPeersScalarsRejectsTabAndIndentMismatch(t *testing.T) {
	t.Parallel()
...
func TestRWI08ParseSimplePeersLineNoSpaceAfterColon(t *testing.T) {
	t.Parallel()
...
func TestRWI08ParseSimplePeersLineBlankValueAfterTrim(t *testing.T) {
	t.Parallel()
...
func TestRWI08IsSimplePeersKeyName(t *testing.T) {
	t.Parallel()
...
func TestRWI08SplitLinesKeepEndsEmpty(t *testing.T) {
	t.Parallel()
...
func TestRWI08VerifyPeersUpstreamEditMismatch(t *testing.T) {
	t.Parallel()
...
func TestRWI08VerifyPeersUpstreamEditDocumentCountChanged(t *testing.T) {
	t.Parallel()
...
func TestRWI08VerifyPeersUpstreamEditTextOutsideChanged(t *testing.T) {
	t.Parallel()
...
func TestRWI08VerifyPeersUpstreamEditPasses(t *testing.T) {
	t.Parallel()
...
func TestRWI08FirstPeersDocumentMap(t *testing.T) {
	t.Parallel()
...
func TestRWI08DecodeAllPeersDocumentsCommentOnly(t *testing.T) {
	t.Parallel()
