...
func TestOwnerRelative(t *testing.T) {
	t.Parallel()
...
func TestOwnersRootMissing(t *testing.T) {
	t.Parallel()
...
func TestOwnersSkipsNonDirOrganization(t *testing.T) {
	t.Parallel()
...
func TestLocateReadDirError(t *testing.T) {
	t.Parallel()
...
func TestLocateOneMatch(t *testing.T) {
	t.Parallel()
...
func TestLocateAmbiguousMatch(t *testing.T) {
	t.Parallel()
...
func TestClonePathForURLExistingClone(t *testing.T) {
	t.Parallel()
...
func TestClonePathForURLLocateError(t *testing.T) {
	t.Parallel()
...
func TestClonePathForURLStatError(t *testing.T) {
	t.Parallel()
...
func TestClonePathForURLFallback(t *testing.T) {
	t.Parallel()
