...
| `stream start`, `stream join`, `stream status`, `stream end`, `stream delete`, `stream sync`, `stream absorb` | yes | rejected | rejected | yes |
...
| `review record` | yes | rejected | rejected | yes |
