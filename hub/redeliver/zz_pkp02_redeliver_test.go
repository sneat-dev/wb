...
func TestPkp02NewDefaults(t *testing.T) {
	t.Parallel()
	sweeper := New(Options{})
...
func TestPkp02TransientDelayFallback(t *testing.T) {
	t.Parallel()
...
func TestPkp02NextPageURL(t *testing.T) {
	t.Parallel()
	cases := []struct {
		name   string
		header string
...
func TestPkp02SleepContextCancelled(t *testing.T) {
	t.Parallel()
