...
wb fleet default-branch --repo acme/app --apply --reconcile-from reports/default-branch/previous.json
```
...
that bounded action with `--reconcile-from` an earlier apply report. Dirty,
