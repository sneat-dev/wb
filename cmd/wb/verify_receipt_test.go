...
func writeGraduationEvidence(t *testing.T) (graduationEvidencePaths, time.Time) {
	...
	deployed := graduation.DeployedRevisionEvidence{SchemaVersion: graduation.SchemaVersion, Producer: graduation.DeploymentProducer, Provider: "github-actions", Repository: "sneat-dev/wb", RunURL: "https://github.com/sneat-dev/wb/actions/runs/42", ProviderRunID: "42", RunIDJSONPointer: "/deployment/run_id", Revision: revision, RevisionJSONPointer: "/deployment/revision", ObservedAt: deployedAt, PayloadJSON: payload, PayloadSHA256: graduation.Digest([]byte(payload))}
	cleanup := graduation.TerminalCleanupEvidence{GeneratedAt: cleanupAt, Phase: "applied", Task: "graduation", AllMerged: true, Apply: true, DeleteRemote: true, OlderThan: "24h0m0s", Results: []worktrees.CleanupResult{{ListResult: worktrees.ListResult{Task: "graduation", Repository: "sneat-dev/wb", CanonicalDir: "/projects/sneat-dev/wb", WorktreeDir: "/worktrees/graduation/sneat-dev/wb", Branch: "feature/graduation", Base: "main", HeadSHA: revision, RemoteHeadSHA: revision, RemoteTargetSHA: revision, IntegratedAtOrigin: true, Clean: true}, Eligible: true, Applied: true, RemoteDeleted: true, WorktreeGone: true, BranchDeleted: true}}}
