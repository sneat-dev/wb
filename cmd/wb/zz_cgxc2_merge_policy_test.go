...
// TestCgxc2ApplySharedRulesetSourceTypeMustBeRepository proves the
...
func TestCgxc2ApplySharedRulesetSourceTypeMustBeRepository(t *testing.T) {
...
// TestCgxc2ApplySharedRulesetRejectsRulesetWithoutRulesField proves the
...
func TestCgxc2ApplySharedRulesetRejectsRulesetWithoutRulesField(t *testing.T) {
...
// TestCgxc2ApplySharedRulesetSkipsNonObjectRuleEntries proves a rule element
...
func TestCgxc2ApplySharedRulesetSkipsNonObjectRuleEntries(t *testing.T) {
	cwDepsStubMergePolicyGitHub(t, func(_ int, endpoint string) []byte {
		if strings.Contains(endpoint, "/rulesets/") {
...
// TestCgxc2ApplySharedRulesetInitializesMissingPullRequestParameters proves
...
// set on it.
func TestCgxc2ApplySharedRulesetInitializesMissingPullRequestParameters(t *testing.T) {
	cwDepsStubMergePolicyGitHub(t, func(_ int, endpoint string) []byte {
		if strings.Contains(endpoint, "/rulesets/") {
...
// TestCgxc2ApplySharedRulesetRefusesWhenNothingToChange proves the terminal
...
func TestCgxc2ApplySharedRulesetRefusesWhenNothingToChange(t *testing.T) {
	cwDepsStubMergePolicyGitHub(t, func(_ int, endpoint string) []byte {
		if strings.Contains(endpoint, "/rulesets/") {
...
// TestCgxc2ApplyMergePolicySkipsNonDriftRepositoriesInLeaseRecheck proves the
...
func TestCgxc2ApplyMergePolicySkipsNonDriftRepositoriesInLeaseRecheck(t *testing.T) {
	cwDepsStubMergePolicyGitHub(t, nil)
...
// TestCgxc2ApplyMergePolicyNormalizesNonPositiveParallelism proves the
...
func TestCgxc2ApplyMergePolicyNormalizesNonPositiveParallelism(t *testing.T) {
	cwDepsStubMergePolicyGitHub(t, nil)
