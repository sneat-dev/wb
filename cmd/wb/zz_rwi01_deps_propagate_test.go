...
// TestRwi01PrintPropagateLocalEachWriteFailureIsSurfaced drives a write
...
func TestRwi01PrintPropagateLocalEachWriteFailureIsSurfaced(t *testing.T) {
	t.Parallel()
...
// TestRwi01PrintPropagateLocalConsumerErrorWriteFailureIsSurfaced targets
...
// be surfaced.
func TestRwi01PrintPropagateLocalConsumerErrorWriteFailureIsSurfaced(t *testing.T) {
	t.Parallel()
