...
// TestRwi01DirectoryArgDefaultsToCurrentDirectory covers directoryArg's
// fallback branch: no args at all (nil), not just an empty first element.
func TestRwi01DirectoryArgDefaultsToCurrentDirectory(t *testing.T) {
	t.Parallel()
...
// TestRwi01PolicyShowPrintsConfigPathStrictAndLayerForbidReason drives `wb
...
func TestRwi01PolicyShowPrintsConfigPathStrictAndLayerForbidReason(t *testing.T) {
...
// TestRwi01PolicyTestReportsFailedAssertions drives `wb deps policy test`
...
func TestRwi01PolicyTestReportsFailedAssertions(t *testing.T) {
