...
func TestPrintRetiredBranchSummaryReportsCountsAndStaysSilentWhenZero(t *testing.T) {
	t.Parallel()
...
func TestPrintBranchCountPropagatesWriteError(t *testing.T) {
	t.Parallel()
...
func TestPrintBranchDiagnosticsPropagatesWriteError(t *testing.T) {
	t.Parallel()
	sentinel := errors.New("stdout is closed")
...
func TestPrintDispositionTotalsPropagatesWriteError(t *testing.T) {
	t.Parallel()
	sentinel := errors.New("stdout is closed")
...
func TestPrintBranchListPropagatesWriteErrorsAtEveryStage(t *testing.T) {
	t.Parallel()
	sentinel := errors.New("stdout is closed")
	outcome := worktrees.BranchListOutcome{
...
func TestPrintBranchCleanupPropagatesWriteErrorsForEveryRowKind(t *testing.T) {
	t.Parallel()
	sentinel := errors.New("stdout is closed")
