...
func TestPkp00ValidateParkedRemoteBundleRejectsEmptyWorktrees(t *testing.T) {
	t.Parallel()
...
func TestPkp00ValidateParkedRemoteBundleRejectsDirtyWorktree(t *testing.T) {
	t.Parallel()
...
func TestPkp00ParkResumeDiagnosticDirEmptyInputsYieldEmptyPath(t *testing.T) {
	t.Parallel()
...
func TestPkp00ParkResumeDiagnosticDirJoinsHomeAndSession(t *testing.T) {
	t.Parallel()
...
func TestPkp00WriteSessionResumeOutputJSONEncodesFields(t *testing.T) {
	t.Parallel()
...
func TestPkp00WriteSessionResumeOutputTextReportsReplayed(t *testing.T) {
	t.Parallel()
	command := &cobra.Command{}
	var out bytes.Buffer
	command.SetOut(&out)
...
func TestPkp00ParkedRemoteSSHConfigRejectsMismatchedTarget(t *testing.T) {
	t.Parallel()
...
func TestPkp00ReadParkContextReadsStdinOnDash(t *testing.T) {
	t.Parallel()
	command := &cobra.Command{}
...
func TestPkp00ReadSessionReceiveParkEnvelopeRejectsBlankInput(t *testing.T) {
	t.Parallel()
	command := &cobra.Command{}
