...
var persistentFlagSupport = map[string]map[string]bool{
	"projects-root": {
		...
		"worktree merge": true, "worktree merge prepare": true, "worktree merge land": true, "worktree merge resume": true, "worktree merge revert": true, "worktree merge acknowledge-landed-failed": true,
