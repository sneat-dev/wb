...
// TestCgxc3WritePrivateCredentialInjectedReportsUnreadableExistingFile
...
func TestCgxc3WritePrivateCredentialInjectedReportsUnreadableExistingFile(t *testing.T) {
	t.Parallel()
	dir := t.TempDir()
