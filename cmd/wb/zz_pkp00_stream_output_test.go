...
func TestPkp00StreamStartOutputTextListsMembers(t *testing.T) {
	t.Parallel()
...
func TestPkp00StreamEndOutputTextReportsMembersPullRequestsAndErrors(t *testing.T) {
	t.Parallel()
	command := &cobra.Command{}
	var out bytes.Buffer
	command.SetOut(&out)
...
func TestPkp00StreamListOutputTextListsStreamsAndUnreadableEntries(t *testing.T) {
	t.Parallel()
	root := t.TempDir()
...
func TestPkp00StreamStatusOutputTextReportsMissingPullRequestsAndEmptyGaps(t *testing.T) {
	t.Parallel()
	command := &cobra.Command{}
	var out bytes.Buffer
	command.SetOut(&out)
...
// lines keep writing.
func TestPkp00StreamStartOutputTextSurfacesWriteFailureAtEveryStatement(t *testing.T) {
	t.Parallel()
	result := streams.StartResult{
		Stream: streams.Stream{Name: "demo", Members: []streams.Member{
			{Repository: "acme/app", Role: streams.RoleLibrary, Worktree: "/wt/app", PullRequest: 7},
...
func TestPkp00StreamEndOutputTextSurfacesWriteFailureAtEveryStatement(t *testing.T) {
	t.Parallel()
	result := streams.EndResult{
		Stream:  "demo",
		Applied: false,
...
func TestPkp00StreamListOutputTextSurfacesWriteFailureAtEveryStatement(t *testing.T) {
	t.Parallel()
	root := t.TempDir()
	store := streams.OpenAt(root)
	if _, err := store.Create(streams.Stream{
...
func TestPkp00StreamStatusOutputTextSurfacesWriteFailureAtEveryStatement(t *testing.T) {
	t.Parallel()
	status := streams.Status{
		Stream: "demo", Branch: "stream/demo",
		Members: []streams.MemberStatus{
...
func TestPkp00StreamStatusOutputTextSurfacesWriteFailureInPopulatedGapSections(t *testing.T) {
	t.Parallel()
	status := streams.Status{
		Stream: "demo", Branch: "stream/demo",
...
func TestPkp00StreamStatusOutputTextReportsPopulatedGaps(t *testing.T) {
	t.Parallel()
	command := &cobra.Command{}
	var out bytes.Buffer
	command.SetOut(&out)
